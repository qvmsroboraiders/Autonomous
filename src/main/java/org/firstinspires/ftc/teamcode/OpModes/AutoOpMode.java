 ...
 */
@Autonomous(name = "RoboRaiders Autonomous Full", group = "00-Autonomous", preselectTeleOp = "AA21386TeleOpSlide")
public class AutoOpMode extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && !opModeIsActive()) {
            ...
            telemetry.addData("ROTATION: ", visionEasyOpenCV.getPosition());
            telemetry.update();
        }
        //Set DEFAULT as LEFT
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            //Set power to 0 to hold that position
            Arm.setPower(0);
